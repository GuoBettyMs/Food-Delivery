    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                else if(Objects.requireNonNull(userpass.getText()).toString().isEmpty()
                        || !(userpass.getText().toString().equals(userconfirm.getText().toString()))){
                ...
                else
                {
                    ...
                    startActivity(
                            new Intent(SignUpActivity.this, MapActivity.class)
