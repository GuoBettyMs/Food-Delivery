...
public class NonVegMenuFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_non_veg_menu, container, false);
        expandingList = view.findViewById(R.id.expanding_list_main_nonveg);
        createItems();
        return view;
    }
    ...
    private void createItems() {
        ...
        map = menu.getMenu_sub_item_nonveg_lunch(); //静态数据
